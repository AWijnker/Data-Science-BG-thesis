...
## loading data
boa_x = pd.read_csv("boa_x.csv")
boa_y = pd.read_csv("boa_y.csv")


# In[ ]:


boa_train_x, boa_test_x, boa_train_y, boa_test_y = train_test_split(boa_x, boa_y, test_size = 0.3, random_state = 2019)
